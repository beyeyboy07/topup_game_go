...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.GameRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.OrderStatusRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.ProviderRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "controllers.OrderStatusRequest": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string",
        ...
        "utils.APIResponse": {
            ...
            "properties": {
                "data": {
                    "description": "Data yang dikirim API."
                },
                "message": {
                    "description": "Message dari API.",
                    "type": "string"
                },
                "status": {
